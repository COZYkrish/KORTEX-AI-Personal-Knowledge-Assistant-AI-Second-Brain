...
export default function SignUpPage() {
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", top: 32, right: 32, width: 120, height: 120, background: B.YELLOW, border: B.border4, opacity: 0.3 }} />
      <div style={{ position: "absolute", bottom: 32, left: 32, width: 96, height: 96, borderRadius: "50%", background: B.RED, border: B.border4, opacity: 0.25 }} />
      <div style={{ position: "absolute", bottom: "33%", right: 64, width: 72, height: 72, background: B.BLUE, border: B.border4, opacity: 0.35, transform: "rotate(45deg)" }} />
      ...
      >
        {/* Red header */}
        <div style={{ background: B.RED, borderBottom: B.border4, padding: "2rem" }}>
          {/* Logo */}
          <div className="flex items-center gap-2 mb-6">
            <div className="flex items-center gap-1">
              <div style={{ width: 12, height: 12, borderRadius: "50%", background: "white",  border: "2px solid white" }} />
              <div style={{ width: 12, height: 12,                       background: B.BLUE,   border: "2px solid white" }} />
          ...
          <SignUp
            ...
            appearance={{
              elements: {
                ...
                footerActionLink: "text-[#D02020] font-bold uppercase tracking-wider text-xs",
              },
            }}
          />
        </div>
