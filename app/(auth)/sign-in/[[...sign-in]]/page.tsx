...
export default function SignInPage() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#F0F0F0] relative overflow-hidden bg-dot-grid">
      ...
      <div className="absolute top-8 left-8 w-32 h-32 bg-[#D02020] border-4 border-[#121212] opacity-30" />
      <div className="absolute bottom-8 right-8 w-24 h-24 rounded-full bg-[#1040C0] border-4 border-[#121212] opacity-30" />
      <div
        className="absolute top-1/3 right-16 w-20 h-20 bg-[#F0C020] border-4 border-[#121212] opacity-40"
        style={{ transform: "rotate(45deg)" }}
      />

      {/* Main Card */}
      <div className="relative z-10 w-full max-w-md bg-white border-4 border-[#121212] shadow-hard-lg mx-4">
        {/* Card Header — Color blocked */}
        <div className="bg-[#1040C0] border-b-4 border-[#121212] p-8">
          {/* Logo */}
          <div className="flex items-center gap-2 mb-6">
            <div className="flex items-center gap-1">
              <div className="w-4 h-4 rounded-full bg-[#D02020] border-2 border-white" />
              <div className="w-4 h-4 bg-white border-2 border-white" />
              <div
          ...
          <SignIn
            ...
            appearance={{
              elements: {
                ...
                formFieldInput: "bg-[#F0F0F0] border-2 border-[#121212] text-[#121212] focus:border-[#1040C0] rounded-none font-medium",
                ...
                footerActionLink: "text-[#1040C0] hover:text-[#D02020] font-black uppercase tracking-wider transition-colors",
                identityPreviewText: "text-[#121212] font-bold",
                identityPreviewEditButton: "text-[#1040C0] font-bold",
